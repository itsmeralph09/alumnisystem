...
<?php } ?> 
        ...
        <div class="card-header bg-dark text-white">
            <strong class="card-title">List of Announcements</strong>
        </div>
                                        ...
                                        <div class="card p-3 rounded">
                                            <div>
                                                <div class="float-left">
                                                    <p class="float-start font-weight-bold mb-0" style="color:#7b0d0d">Announcement #: <?php echo $row['announcement_id']; ?></p>
                                                </div>
                                            ...
                                            <div class="rounded my-2">
                                                <div class="float-left">
                                                    <p class="text-primary font-italic mb-0">" <?php echo $row['content']; ?> "</p>
                                                </div>
                                            </div>
                                            <hr>
